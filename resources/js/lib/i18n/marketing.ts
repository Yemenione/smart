export const marketingTranslations = {
    fr: {
        hero: {
            ...
            eliteSolutions: "SOLUTIONS ÉLITE",
            exclusiveOffers: "OFFRES EXCLUSIVES."
        },
        partners: {
            title: "RECONNUS MONDIALEMENT",
            subtitle: "ACCOMPAGNER LES LEADERS DU MARCHÉ",
        },
        techStack: {
            title: "ARCHITECTURE & STACK",
            subtitle: "CONSTRUIT AVEC LES MEILLEURES TECHNOLOGIES",
        },
        homeServices: {
        ...
        servicesPage: {
            ...
            subtitle: "Nous opérons à l'intersection du design brutalisme et de l'ingénierية de haute précision. Nos services sont des architectures conçues pour l'impact.",
            items: {
                engineering: {
        ...
        agencyPage: {
            ...
            subtitle: "Smartouies n'est pas une simple agence. C'est un laboratoire où la technologie rencontre l'art numérique.",
    ...
    en: {
        hero: {
            ...
            eliteSolutions: "ELITE SOLUTIONS",
        ...
        techStack: {
            title: "ARCHITECTURE & STACK",
            subtitle: "BUILT WITH THE BEST TECHNOLOGIES",
        },
        homeServices: {
        ...
        agencyPage: {
            ...
            subtitle: "Smartouies is not just an agency. It's a laboratory where technology meets digital art.",
