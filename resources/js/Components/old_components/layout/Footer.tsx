...
export default function Footer() {
    ...
    return (
        <footer id="agency" className="min-h-[80vh] relative flex flex-col items-center justify-center bg-[#020202] overflow-hidden px-4">
            ...
            >
                <motion.div variants={itemVariants} className="mb-8">
                    <Link href="/">
                        <ApplicationLogo className="h-12 md:h-16 text-white" />
                    </Link>
                </motion.div>
                ...
                >
                    ...
                    <div className="flex flex-wrap gap-4 md:gap-6 justify-center">
                        ...
                        {socials.socialTwitter && <a href={socials.socialTwitter} target="_blank" rel="noopener noreferrer" className="hover:text-accent transition-colors">Twitter (X)</a>}
                        {socials.socialLinkedin && <a href={socials.socialLinkedin} target="_blank" rel="noopener noreferrer" className="hover:text-accent transition-colors">LinkedIn</a>}
                        {socials.socialInstagram && <a href={socials.socialInstagram} target="_blank" rel="noopener noreferrer" className="hover:text-accent transition-colors">Instagram</a>}
                        {socials.socialFacebook && <a href={socials.socialFacebook} target="_blank" rel="noopener noreferrer" className="hover:text-accent transition-colors">Facebook</a>}
                        {(!socials.socialTwitter && !socials.socialLinkedin && !socials.socialInstagram && !socials.socialFacebook) && (
                            <>
