...
export default function Show({ initialProject }: { initialProject: any }) {
    ...
    const getImageUrl = (imagePath: string | null | undefined) => {
        ...
        const STORAGE_URL = "/storage"; // In Laravel, the public storage folder is accessible here
        return `${STORAGE_URL}/${imagePath}`;
    };

    // Ensure "services" and "galleryImages" exist as fallbacks
    ...
    const docTitle = `${language === 'fr' && project.titleFr ? project.titleFr : project.title} | ${siteName}`;
                ...
                <section className="md:hidden w-full px-4 -mt-16 mb-8 relative z-20">
                    <div className="flex flex-wrap gap-3 py-6 border-b border-white/10">
                        ...
                        <div className="mt-4 w-full">
                            <ShareWidget
                                title={project.title}
                                description={project.challenge || t.project.exploreMore}
                        ...
                        {galleryImages.map((img, idx) => (
                            ...
                            >
                                <img
                                    ...
                                    className="object-cover w-full h-full transition-transform duration-[2s] hover:scale-105"
                                />
                            </motion.div>
                        ))}
                    </div>
