...
export default function PrivacyPolicy() {
    return (
        <>
            <h1 className="text-4xl md:text-5xl font-heading font-bold text-white mb-12 tracking-tight">
                Privacy Policy
            </h1>

            <div className="space-y-12">
                <section>
                    <h2 className="text-2xl font-heading text-white mb-4">1. Information Collection</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-2xl font-heading text-white mb-4">2. Use of Data</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-2xl font-heading text-white mb-4">3. Data Security</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-2xl font-heading text-white mb-4">4. Cookies</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-2xl font-heading text-white mb-4">5. Contact Us</h2>
                    <p>
                        If you have questions about this Privacy Policy, please contact our legal team at:
                        <br />
                        <a href="mailto:legal@deuleux.com" className="text-white hover:underline mt-2 inline-block">
                            legal@deuleux.com
                        </a>
                    </p>
                </section>

                <div className="pt-12 border-t border-white/10 text-sm text-neutral-500">
