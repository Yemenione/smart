...
export default function TermsOfService() {
    return (
        <>
            <h1 className="text-4xl md:text-6xl font-heading font-bold text-white mb-12 tracking-tight">
                Terms of Service / <br />
            ...
            <div className="space-y-12">
                ...
                <section>
                    <h2 className="text-2xl font-heading text-white mb-4">2. Intellectual Property</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-2xl font-heading text-white mb-4">3. Limitation of Liability</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-2xl font-heading text-white mb-4">4. Governing Law</h2>
                    <p>
