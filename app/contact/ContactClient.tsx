                                ...
                                <motion.div variants={itemVariants} className="relative group flex flex-col focus-within:text-glow">
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            className="w-full bg-transparent text-accent font-mono text-lg md:text-xl py-3 focus:outline-none focus:ring-0 peer placeholder:text-accent/20 disabled:opacity-50"
                                ...
                                <motion.div variants={itemVariants} className="relative group flex flex-col focus-within:text-glow">
                                    ...
                                    <div className="relative">
                                        <textarea
                                            ...
                                            disabled={status === "submitting"}
                                            className="w-full bg-transparent text-accent font-mono text-lg md:text-xl py-3 focus:outline-none focus:ring-0 peer placeholder:text-accent/20 resize-none disabled:opacity-50"
