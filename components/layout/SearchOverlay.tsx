            ...
            {isOpen && (
                ...
                >
                    ...
                    <div className="flex justify-between items-center p-6 md:p-10">
                        <span className="font-heading text-xl font-bold tracking-tighter text-white/40">DEULEUX SEARCH</span>
                        <button
                            onClick={onClose}
                        ...
                        <div className="max-w-5xl mx-auto pt-10 md:pt-20">
                            <div className="relative mb-12">
                                ...
                                <input
                                    ...
                                    placeholder={language === 'fr' ? "QUE RECHERCHEZ-VOUS ?" : "WHAT ARE YOU LOOKING FOR?"}
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                                {/* Projects Results */}
                                <div>
                                    <h3 className="text-xs font-mono tracking-[0.3em] uppercase text-accent mb-8">PROJECTS / REALISATIONS</h3>
                                    <div className="space-y-6">
                                        {results.projects.length > 0 ? results.projects.map(project => (
                                            ...
                                            <p className="text-white/20 italic">No projects found.</p>
                                        ) : (
                                ...
                                {/* Posts Results */}
                                <div>
                                    <h3 className="text-xs font-mono tracking-[0.3em] uppercase text-accent mb-8">INSIGHTS / PERSPECTIVES</h3>
                                    <div className="space-y-6">
                                        {results.posts.length > 0 ? results.posts.map(post => (
                                            ...
                                            <p className="text-white/20 italic">No posts found.</p>
                                        ) : (
                                            <div className="space-y-4 text-white/30">
